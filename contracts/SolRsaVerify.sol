...
contract SolRsaVerify {
    ...
    function memcpy(uint _dest, uint _src, uint _len) view internal {
        console.log('SC ==> Memcpy 1 ==>', _len);
    ...
    */    
    ...
    function returnSHA256(bytes memory _data) public view returns(bytes32) {
        return sha256(_data);
    }
}